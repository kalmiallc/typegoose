...
class Typegoose {
    getModelForClass(t, { existingMongoose, schemaOptions, existingConnection, extraOptions, } = {}) {
    ...
    setModelForClass(t, { existingMongoose, schemaOptions, existingConnection, extraOptions, } = {}) {
        const name = this.constructor.name;
    ...
    buildSchema(name, schemaOptions, sch, extraOptions) {
